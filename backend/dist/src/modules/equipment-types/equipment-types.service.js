...
exports.EquipmentTypesService = void 0;
const common_1 = require("@nestjs/common");
const prisma_module_1 = require("../../prisma.module");
const prisma_errors_util_1 = require("../../common/utils/prisma-errors.util");
let EquipmentTypesService = class EquipmentTypesService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    findAll() {
    ...
    async findOne(id) {
        ...
        if (!item)
            throw new common_1.NotFoundException('Tipo de equipamento não encontrado');
        return item;
    }
    create(dto) {
    ...
    async remove(id) {
        ...
        try {
            ...
            (0, prisma_errors_util_1.handlePrismaDeleteError)(error, 'tipo de equipamento');
        }
    }
};
exports.EquipmentTypesService = EquipmentTypesService;
exports.EquipmentTypesService = EquipmentTypesService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_module_1.PrismaService])
], EquipmentTypesService);
//# sourceMappingURL=equipment-types.service.js.map