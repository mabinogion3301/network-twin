...
const port_dto_1 = require("./dto/port.dto");
...
__decorate([
    (0, common_1.Get)(),
    (0, auth_decorators_1.Permissions)('ports.read'),
    __param(0, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [port_dto_1.PortQueryDto]),
...
__decorate([
    (0, common_1.Post)(),
    (0, auth_decorators_1.Permissions)('ports.create'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [port_dto_1.CreatePortDto]),
    __metadata("design:returntype", void 0)
], PortsController.prototype, "create", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, auth_decorators_1.Permissions)('ports.update'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, port_dto_1.UpdatePortDto]),
    __metadata("design:returntype", void 0)
], PortsController.prototype, "update", null);
__decorate([
    (0, common_1.Delete)(':id'),
    (0, auth_decorators_1.Permissions)('ports.delete'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
