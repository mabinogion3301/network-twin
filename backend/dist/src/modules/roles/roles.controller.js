...
__decorate([
    (0, common_1.Get)(),
    (0, auth_decorators_1.Permissions)('roles.read'),
...
__decorate([
    (0, common_1.Post)(),
    (0, auth_decorators_1.Permissions)('roles.create'),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, auth_decorators_1.Permissions)('roles.update'),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, auth_decorators_1.Permissions)('roles.delete'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
